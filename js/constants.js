...
const COLLISION_GRID_COLS = 30;
const COLLISION_GRID_ROWS = 22;
const COLLISION_CELL_WIDTH = FIELD_WIDTH / COLLISION_GRID_COLS;   // 40
const COLLISION_CELL_HEIGHT = FIELD_HEIGHT / COLLISION_GRID_ROWS; // ~41
